...
# Configuração das meias-finais:
# vencedor QF1 vs vencedor QF2
# vencedor QF3 vs vencedor QF4
CONFIG_MEIAS = [
    (
        "2026-07-14",
        "20:00",
...
def main():
    ...
    backup = FICHEIRO.with_name(
        f"{FICHEIRO.stem}"
        f"_backup_antes_verificar_meias_"
    ...
    for data, hora, jogo1, jogo2 in CONFIG_MEIAS:
        ...
        ws.cell(linha, FASE_COL).value = "SF"
    ...
    if pendentes:
        ...
        print("")
        print(
            "OK: as 2 meias-finais estão resolvidas."
        )
